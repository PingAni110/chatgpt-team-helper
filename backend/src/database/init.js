...
const ensureRbacTables = (database) => {
  ...
  try {
    ...
    const defaultMenus = [
      ...
      { key: 'xhs_orders', label: '小红书订单', path: '/admin/xhs-orders', parentKey: 'order_management', sortOrder: 3 },
      { key: 'xianyu_orders', label: '闲鱼订单', path: '/admin/xianyu-orders', parentKey: 'order_management', sortOrder: 4 },
